...
SYNERGY_V10_VG1_ASSET_KEYS = [
    "b0Data", "b2Data", "b3Data", "mirData", "ndviData","vaaData", 
    "vzaData", "saaData", "szaData", "agData", "ogData", "wvgData",
    "tgData", "smData"
]

SYNERGY_VGP_ASSET_KEYS = [
    "b0Data", "b2Data", "b3Data", "mirData", "vaaData", 
    "vzaData", "saaData", "szaData", "agData", "ogData", 
    "wvgData", "smData"
]
...
OLCI_L2_LAND_ASSET_KEYS = [
    "ogviData", "otciData", "iwvData", 
    "rcOgviData", "lqsfData", "timeCoordinatesData", 
    "geoCoordinatesData", "tieGeoCoordinatesData", "tieGeometriesData", 
    "tieMeteoData", "instrumentDataData"
]
...
SLSTR_L2_FRP_KEYS = [
    ...
    "SLSTR_GEODETIC_FN_Data", "SLSTR_GEODETIC_IN_Data", "SLSTR_GEODETIC_TX_Data", 
    "SLSTR_GEOMETRY_TN_Data", "SLSTR_INDICES_FN_Data", "SLSTR_INDICES_IN_Data", 
    "SLSTR_MET_TX_Data", "SLSTR_TIME_IN_Data"
]

SLSTR_L2_LST_KEYS = [
    "LST_IN_Data", "LST_ANCILLARY_DS_Data", "SLSTR_FLAGS_IN_Data", 
    "SLSTR_INDICES_IN_Data", "SLSTR_TIME_IN_Data", "SLSTR_GEODETIC_IN_Data", 
    "SLSTR_CARTESIAN_IN_Data", "SLSTR_GEOMETRY_TN_Data", "SLSTR_GEODETIC_TX_Data", 
    "SLSTR_CARTESIAN_TX_Data", "SLSTR_MET_TX_Data"
]

SRAL_L2_LAN_WAT_KEYS = [
    "standardMeasurementData", "enhancedMeasurementData", "reducedMeasurementData"
]
